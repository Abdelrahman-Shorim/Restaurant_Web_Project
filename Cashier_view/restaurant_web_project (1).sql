...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2022 at 11:01 PM
...
INSERT INTO `comments` (`C_ID`, `U_ID`, `I_ID`, `comment`) VALUES
(1, 1, 20, 'really great meal'),
(2, 6, 10, 'great meal woow'),
(3, 6, 10, 'great meal woow'),
(4, 6, 10, 'afad'),
(5, 6, 10, 'fda'),
(6, 6, 10, 'adsfaf'),
(7, 6, 10, 'hehehehe'),
(8, 6, 11, 'yes'),
(9, 3, 27, 'awesome dessert'),
(10, 3, 23, 'mina is here'),
(11, 7, 31, 'habiba is here');
...
(1, 6, 'Sun, 05 Jun 2022 14:', 2, '2313.87', 2),
(2, 6, 'Sun, 05 Jun 2022 14:', 1, '488.61', 2),
(3, 7, 'Tue, 07 Jun 2022 22:', 1, '1855.68', 2);
...
INSERT INTO `rate` (`R_ID`, `U_ID`, `I_ID`, `rate`) VALUES
(1, 1, 47, '3'),
(2, 1, 47, '1'),
(3, 1, 47, '5'),
(4, 1, 47, '4'),
...
(6, 'Abdo', 'Ayman', 'ab@gmail.com', '12345678', 'Profile_pictures/ab@gmail.com', 30123345567832, 1, '0123456789', 1),
(7, 'Abdo', 'Ayman', 'lolo@gmail.com', '12345678', 'Profile_pictures/lolo@gmail.com', 12345678901234, 1, '01006581676', 1);
...
--
ALTER TABLE `rate`
  MODIFY `R_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
